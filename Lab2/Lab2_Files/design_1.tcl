...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_gpio_BLUE, and set properties
  set axi_gpio_BLUE [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_BLUE ]
  set_property -dict [ list \
  ...
  # Create instance: axi_gpio_GREEN, and set properties
  set axi_gpio_GREEN [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_GREEN ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_ALL_OUTPUTS_2 {1} \
   CONFIG.C_GPIO2_WIDTH {8} \
  ...
  # Create instance: axi_gpio_RED, and set properties
  set axi_gpio_RED [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 axi_gpio_RED ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_ALL_OUTPUTS_2 {1} \
   CONFIG.C_GPIO2_WIDTH {8} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_gpio_RED/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_GREEN/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins axi_gpio_BLUE/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins axi_gpio_CTRL/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]

  # Create port connections
  connect_bd_net -net Debouncer_BLUE_pls_o [get_bd_pins Debouncer_BLUE/pls_o] [get_bd_pins axi_gpio_BLUE/gpio_io_i]
  connect_bd_net -net Debouncer_CTRL_pls_o [get_bd_pins Debouncer_CTRL/pls_o] [get_bd_pins axi_gpio_CTRL/gpio_io_i]
  connect_bd_net -net Debouncer_GREEN_pls_o [get_bd_pins Debouncer_GREEN/pls_o] [get_bd_pins axi_gpio_GREEN/gpio_io_i]
  connect_bd_net -net Debouncer_RED_pls_o [get_bd_pins Debouncer_RED/pls_o] [get_bd_pins axi_gpio_RED/gpio_io_i]
  ...
  connect_bd_net -net axi_gpio_BLUE_gpio2_io_o [get_bd_pins PWM_BLUE/data_i] [get_bd_pins axi_gpio_BLUE/gpio2_io_o]
  connect_bd_net -net axi_gpio_BLUE_ip2intc_irpt [get_bd_pins axi_gpio_BLUE/ip2intc_irpt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net axi_gpio_CTRL_ip2intc_irpt [get_bd_pins axi_gpio_CTRL/ip2intc_irpt] [get_bd_pins xlconcat_0/In3]
  connect_bd_net -net axi_gpio_GREEN_gpio2_io_o [get_bd_pins PWM_GREEN/data_i] [get_bd_pins axi_gpio_GREEN/gpio2_io_o]
  connect_bd_net -net axi_gpio_GREEN_ip2intc_irpt [get_bd_pins axi_gpio_GREEN/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net axi_gpio_RED_gpio2_io_o [get_bd_pins PWM_RED/data_i] [get_bd_pins axi_gpio_RED/gpio2_io_o]
  connect_bd_net -net axi_gpio_RED_ip2intc_irpt [get_bd_pins axi_gpio_RED/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_BLUE/s_axi_aclk] [get_bd_pins axi_gpio_CTRL/s_axi_aclk] [get_bd_pins axi_gpio_GREEN/s_axi_aclk] [get_bd_pins axi_gpio_RED/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_gpio_BLUE/s_axi_aresetn] [get_bd_pins axi_gpio_CTRL/s_axi_aresetn] [get_bd_pins axi_gpio_GREEN/s_axi_aresetn] [get_bd_pins axi_gpio_RED/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  connect_bd_net -net sysclk_1 [get_bd_ports sysclk] [get_bd_pins Debouncer_BLUE/clk_i] [get_bd_pins Debouncer_CTRL/clk_i] [get_bd_pins Debouncer_GREEN/clk_i] [get_bd_pins Debouncer_RED/clk_i] [get_bd_pins PWM_BLUE/clk_i] [get_bd_pins PWM_GREEN/clk_i] [get_bd_pins PWM_RED/clk_i]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins processing_system7_0/IRQ_F2P] [get_bd_pins xlconcat_0/dout]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_BLUE/S_AXI/Reg] SEG_axi_gpio_BLUE_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_CTRL/S_AXI/Reg] SEG_axi_gpio_CTRL_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_GREEN/S_AXI/Reg] SEG_axi_gpio_GREEN_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_RED/S_AXI/Reg] SEG_axi_gpio_RED_Reg
